...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_user_list_vue__ = __webpack_require__(539);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_6a0ce2b6_hasScoped_false_preserveWhitespace_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_user_list_vue__ = __webpack_require__(556);
var disposed = false
...
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_6a0ce2b6_hasScoped_false_preserveWhitespace_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_user_list_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
Component.options.__file = "src/views/user/user-list.vue"
...
if (true) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-6a0ce2b6", Component.options)
  } else {
    hotAPI.reload("data-v-6a0ce2b6", Component.options)
  }
...
exports.default = {
    ...
    mounted: function mounted() {
        ...
        this.fetchUserList({ cur: 1, params: { name: name, tag: tag } });
        // this.fetchUserList();
    },

    methods: (0, _extends3.default)({}, (0, _vuex.mapActions)(['fetchUserList', 'fetchUserDel']), {
        getSize: function getSize(size) {
            var _key2 = this.key,
                name = _key2.name,
                tag = _key2.tag;

            this.fetchUserList({ cur: size, params: { name: name, tag: tag } });
        ...
        deleteUser: function deleteUser(row) {
            ...
            var id = row.uuid;
            this.fetchUserDel({ uuid: id, fn: function fn() {
                    var msg = "删除成功";
                    ...
                    _this.fetchUserList({ cur: 1, params: { name: name, tag: tag } });
                } });
        },
          ...
          _c(
            ...
            [
              _c(
                "el-table",
                {
                  attrs: { data: _vm.userState.users },
              ...
              _vm.userState.total > _vm.userState.pageSize
                ? _c("el-pagination", {
                    attrs: {
                      background: "",
                      layout: "prev, pager, next",
                      pageSize: _vm.userState.pageSize,
                      total: _vm.userState.total
                    },
...
if (true) {
  module.hot.accept()
  if (module.hot.data) {
    __webpack_require__(140)      .rerender("data-v-6a0ce2b6", esExports)
  }
}
...
//# sourceMappingURL=4.39527bdf6dc6ba84d3e0.js.map